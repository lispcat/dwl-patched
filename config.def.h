...
static const char *const autostart[] = {
	"/bin/sh", "-c", "sleep 0.5; slstatus-dwlb-run.sh", NULL,
	"/bin/sh", "-c", "wbg $HOME/Pictures/library/wallpapers/glt-landscape2.png", NULL,
...
static const struct xkb_rule_names xkb_rules = {
	...
	*/
	...
	.options = "caps:ctrl_modifier,shift:both_capslock_cancel",  // different for nixos xkb
};
...
static const char *volup2[]   = { "amixer", "set", "Master", "5%+", NULL };
static const char *voldown[]  = { "amixer", "set", "Master", "10%-", NULL };
static const char *voldown2[] = { "amixer", "set", "Master", "5%-", NULL };
